...
public enum Endpoint {
    ...
    // MISC
    MSC_Quote(Request.Method.POST, "/quote", false, new JSONObject().put("avatar", "").put("dateFormat", "").put("message", "").put("nameColor", "").put("timestamp", Long.MAX_VALUE).put("username", ""), ReturnType.RAW_IMAGE),
    MSC_Status(Request.Method.POST, "/status", false, new JSONObject().put("avatar", "").put("status", "").put("mobile", false), ReturnType.RAW_IMAGE),
    // SFW IMAGES
    ...
    SFW_Eevee(Request.Method.GET,"/img/sfw/eevee/", false,null, ReturnType.JSON, ReturnType.JSON_w_IMG, ReturnType.JSON_w_GIF),
    ...
    NSFW_Neko(Request.Method.GET,"/img/nsfw/neko/", true, null, ReturnType.JSON, ReturnType.JSON_w_IMG, ReturnType.JSON_w_GIF),
